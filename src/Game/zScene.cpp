...
// IMPORTANT: find home for this
void xVec3ScaleC(xVec3* o, const xVec3* v, F32 x, F32 y, F32 z) WIP // not decmped
{
}
...
static void zSceneRenderPreFX() RIMP WIP
{
    zScene* s = globals.sceneCur;
...
static void zSceneRenderPostFX() RIMP
{
