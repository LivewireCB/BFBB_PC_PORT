...
void main(S32 argc, char** argv)
{
    ...
    xUtilStartup();
    xSerialStartup(128, (st_SERIAL_PERCID_SIZE*)&g_xser_sizeinfo); // TODO: seils code just has g_zser_sizeinfo. No cast or &
    zDispatcher_Startup();
    xScrFxInit();
    xFXStartup();
    zMainShowProgressBar();
...
void zMainMemCardSpaceQuery() RIMP
{
    /*S32 bytesNeeded;
    S32 availOnDisk;
    S32 neededFiles;
