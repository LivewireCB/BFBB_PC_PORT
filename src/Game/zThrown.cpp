...
void xDrawSphere(const xVec3* center, F32 r, U32 flags) WIP // not decomped? needs moved too
{
}

S32 zThrownCollide_CauseDamage(zThrownStruct* thrown, xEntCollis* collis) WIP
{
    return 0;
}
...
xBase* zThrown_ButtonIteratorCB(xBase* b, zScene* scn, void* user) WIP
{
    return NULL;
}