...
void zEntPickup_Update(zEntPickup* ent, xScene* sc, F32 dt) WIP // function not decomped
{
}
...
void zEntPickup_RenderList(zEntPickup* plist, U32 pcount) WIP // not decomped
{
}