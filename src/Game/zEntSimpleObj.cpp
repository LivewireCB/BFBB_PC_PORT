...
void zEntSimpleObj_Move(xEnt*, xScene*, F32, xEntFrame*) WIP // not deocmped?
{
}
...
S32 zEntSimpleObjEventCB(xBase* from, xBase* to, U32 toEvent, const F32* toParam, xBase* base3) RIMP
{
