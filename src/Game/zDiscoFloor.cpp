...
U32 current_disco_floor;
 ...
 F32 _710_2 = 1.0f; // 1.0f
 F32 _908 = 1.5f; // 1.5f
 F32 _909_1 = 5.0f; // 5.0f
 F32 _910 = 6.0f; // 6.0f
 F32 _911_1 = 0.01f; // 0.01f
 F32 _912 = 0.05f; // 0.05f
 F32 _913_0 = 17.0f; // 17.0f
 F32 _914_0 = -10.0f; // -10.0f
 F32 _915 = 0.95f; // 0.95f
 F32 _916_0 = 27.0f; // 27.0f
 F32 _917_1 = 0.231f; // 0.231f
 F32 _918_1 = 0.75f; // 0.75f
 F32 _919_1 = 0.0f; // 0.0f
 F32 _1129 = 0.25f; // 0.25f
 F32 _1174_0 = 2*PI; // 2*PI
 F32 _1260_1 = 0.1f; // 0.1f
 F32 _1270_1 = 0.5f; // 0.5f
 F32 _1271_0 = 0.2f; // 0.2f
 F32 _1272 = 0.7f; // 0.7f
 F32 _1273_0 = 0.3f; // 0.3f
 F32 _1406 = 25.0f; // 25.0f
 F32 _1407 = 100.0f; // 100.0f
 F32 _1419_2 = 10.0f; // 10.0f
 F32 _1461_0 = 0.35f; // 0.35f
 F32 _1462_0 = 255.0f; // 255.0f
...
namespace
{
    ...
    void set_object_state(const z_disco_floor&, size_t, S32) WIP // not decomped
    {
    }
