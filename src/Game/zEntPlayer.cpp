...
void zEntPlayer_GiveSpatula(S32) RIMP
{
    sSpatulaGrabbed = 1;
...
// Possibly equivalent?
void zEntPlayer_SNDPlayStream(_tagePlayerStreamSnd player_snd, U32 flags) RIMP WIP
{
    /*if (globals.cmgr == NULL && !sPlayerIgnoreSound)
    {
...
xVec3* zNPCCommon::Pos()
{
    return (xVec3*)&model->Mat->pos;
}

void zEntPlayer_ShadowModelEnable() WIP // not deocmped
{
}

void zEntPlayer_ShadowModelDisable() WIP // not decomped
{
}
