...
namespace
{
    static void SwapModel(zEntDestructObj* ent, xModelInstance* modelInst) RIMP
    {
...
void zEntDestructObj_Move(zEntDestructObj* ent, xScene* scene, F32 unk, xEntFrame* frame) WIP
{
}
