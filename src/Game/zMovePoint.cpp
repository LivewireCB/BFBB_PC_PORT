...
zMovePoint* zMovePoint_GetMemPool(S32 cnt) WIP // review this. commented line is the decomp counterpart
{
...
S32 zMovePointEventCB(xBase* from, xBase* to, U32 toEvent, const F32* toParam, xBase* b3) RIMP
{
    switch (toEvent)
    {
    case eEventOn:
