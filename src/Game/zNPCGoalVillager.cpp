...
S32 zNPCGoalTalk::Exit(F32 dt, void* updCtxt) RIMP
{
    zNPCVillager* npc = (zNPCVillager*)psyche->clt_owner;
...
S32 zNPCGoalSpeak::Enter(F32 dt, void* updCtxt) RIMP
{
    zNPCVillager* npc = (zNPCVillager*)psyche->clt_owner;
    //npc->WonderOfTalking(1, NULL);
    //xVec3Copy(&pos_maintain, xEntGetPos(npc));
...
S32 zNPCGoalSpeak::Exit(F32 dt, void* updCtxt) RIMP
{
    zNPCVillager* npc = (zNPCVillager*)psyche->clt_owner;
    //npc->WonderOfTalking(0, NULL);
    //npc->RestoreColFlags();
...
S32 zNPCGoalCheer::Enter(F32 dt, void* updCtxt) RIMP
{
    zNPCVillager* npc = (zNPCVillager*)psyche->clt_owner;
...
// Equivalent: regalloc
S32 zNPCGoalCheer::Process(en_trantype* trantype, F32 dt, void* updCtxt, xScene* scene) RIMP
{
...
S32 zNPCGoalHurt::Enter(F32 dt, void* updCtxt) RIMP
{
    zNPCVillager* npc = (zNPCVillager*)psyche->clt_owner;
...
S32 zNPCGoalHurt::Process(en_trantype* trantype, F32 dt, void* updCtxt, xScene* scene) RIMP
{
    zNPCVillager* npc = (zNPCVillager*)psyche->clt_owner;
    //npc->VelStop();
...
S32 zNPCGoalBoyRide::Process(en_trantype* trantype, F32 dt, void* updCtxt, xScene* scene) RIMP
{
    S32 nextgoal = 0;
    zNPCBalloonBoy* npc = (zNPCBalloonBoy*)psyche->clt_owner;
    if (npc->plat_balloons == NULL)
...
S32 zNPCGoalBoyRide::NPCMessage(NPCMsg* mail) RIMP
{
    zNPCBalloonBoy* npc = (zNPCBalloonBoy*)psyche->clt_owner;
    S32 handled = 1;
...
S32 zNPCGoalBoyFall::Process(en_trantype* trantype, F32 dt, void* updCtxt, xScene* scene) RIMP
{
    S32 nextgoal = 0;
    zNPCBalloonBoy* npc = (zNPCBalloonBoy*)psyche->clt_owner;
