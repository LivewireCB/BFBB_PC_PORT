...
namespace
{
    char* zVarGameSlotInfo(S32 i, char* buffer, size_t something) WIP
    {
        char date[0x20] = "";
        char time[0x20] = "";
        S32 hour;
    ...
    char* var_text_MCAccessType() WIP
    {
    ...
    char* var_text_MCAutoSaveCard() WIP
    {
        static char buffer[0x0C];
    ...
    char* var_text_MCSelectedCard() WIP
    {
        static char buffer[0x0C];
    ...
    char* var_text_MCSelectedGame() WIP
    {
        static char buffer[0x0C];
    ...
    char* var_text_SpaceAvailable() WIP
    {
        static char buffer[0x0C];
    ...
    char* var_text_SpaceAvailableString() WIP
    {
...
U32 zVarEntryCB_Hour(void*) WIP
{
    //return iGetHour();
    return 0;
}

U32 zVarEntryCB_Minute(void*) WIP
{
    //return iGetMinute();
    return 0;
}
