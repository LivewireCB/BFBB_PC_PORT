...
xPar* xParEmitterEmit(xParEmitter* pe, F32 emit_dt, F32 par_dt) RIMP
{
    xPar* p;
    /*xPar* last_p;
    xMat4x3* bone_mat;
...
void sSaveEmmiterSettings(xParEmitterAsset* a, xParEmitterAsset* b, F32 c) WIP // This doesnt belong here?
{
}

void sSaveEmmiterPropSettings(xParEmitterPropsAsset* a, xParEmitterPropsAsset* b, F32 c) WIP // This doesnt belong here?
{
}
